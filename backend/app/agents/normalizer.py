...
async def run_normalizer_with_provider(llm_provider, text: str, toggles: List[str]) -> dict:
    """
    Normalize and classify user input using provided LLM provider.
    ...
    if sanitized:
        logger.warning("PII was detected and removed from input")
